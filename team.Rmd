...
# This project utilized using git to colaborate on a project with another partner.  Instead of submitting individual Rmd files, we were working with one Rmd file.  The workflow was pretty balanced. We met after class to discuss the project overview. We then worked remotely from our own seperate devices. I was doing the coding.  My partner wrote the descriptions of my codes. There were some issues along the way. Besides these issues, we were able to work around them and work as a team remotley from our own computers.  I believe this was the main idea of lab 2 and I believe we both did a good job. 